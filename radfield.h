...
void close_file();
void update_estimators(int modelgridindex, double distance_e_cmf, double nu_cmf, double doppler_nucmf_on_nurf);
...
auto get_T_J_from_J(int modelgridindex) -> double;
auto get_Jblueindex(int lineindex) -> int;
auto get_Jb_lu(int modelgridindex, int jblueindex) -> double;
auto get_Jb_lu_contribcount(int modelgridindex, int jblueindex) -> int;
...
constexpr auto dbb(double nu, auto T, auto W) -> double
