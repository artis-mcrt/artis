...
void close_file();
__host__ __device__ void update_estimators(ptrdiff_t nonemptymgi, double distance_e_cmf, double nu_cmf,
                                           double doppler_nucmf_on_nurf, const Phixslist& phixslist, bool thickcell);
__host__ __device__ void update_lineestimator(int nonemptymgi, int lineindex, double increment);
[[gnu::pure]] [[nodiscard]] __host__ __device__ auto radfield(double nu, int nonemptymgi) -> double;
...
[[nodiscard]] __host__ __device__ auto get_bfrate_estimator(int element, int lowerion, int lower, int phixstargetindex,
