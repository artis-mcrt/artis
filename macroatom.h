...
__host__ __device__ double col_deexcitation_ratecoeff(float T_e, float nne, double epsilon_trans, int element, int ion,
                                                      int upper, int i);

__host__ __device__ double col_excitation_ratecoeff(float T_e, float nne, int element, int ion, int lower, int i,
