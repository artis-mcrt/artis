#include "update_packets.hpp"

#include <stdlib.h>  // for abort

#include <algorithm>  // for sort
#include <ctime>      // for time, NULL, time_t

#include "artisoptions.hpp"  // for INSTANT_PARTICLE_DEPOSITION
#include "constants.hpp"     // for H, MEV
#include "decay.hpp"         // for DECAYTYPE_ALPHA, DECAYTYPE_BETAMINUS
#include "gammapkt.hpp"      // for do_gamma, pellet_gamma_decay
#include "globals.hpp"       // for time, time_step, cellhistory, npkts, tmin
#include "grid.hpp"          // for get_cell_modelgridindex, get_rho, get_...
#include "gsl/gsl_rng.h"     // for gsl_rng_uniform
#include "kpkt.hpp"          // for do_kpkt, do_kpkt_bb
#include "macroatom.hpp"     // for do_macroatom
#include "nonthermal.hpp"    // for do_ntlepton
#include "packet.hpp"        // for packet, TYPE_ESCAPE, TYPE_NONTHERMAL_P...
#include "rpkt.hpp"          // for do_rpkt
#include "sn3d.hpp"          // for safeadd, printout, assert_always, rng
#include "stats.hpp"         // for get_counter, increment, COUNTER_UPDATE...
#include "update_grid.hpp"   // for cellhistory_reset
#include "vectors.hpp"       // for vec_scale
