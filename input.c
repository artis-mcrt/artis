...
/*  #ifdef FORCE_LTE
  ...
  nu_min_r = NU_MIN_R;   /// lower frequency boundary for UVOIR spectra and BB sampling
  nu_max_r = NU_MAX_R;   /// upper frequency boundary for UVOIR spectra and BB sampling
