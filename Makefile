...
#  CFLAGS = -Wall -O0g -g -std=c11 -I$(INCLUDE) $(VER)
  CFLAGS = -Wall -Wextra -Wundef -Wstrict-prototypes -Wmissing-prototypes -Wno-unused-parameter -O3 -march=native -flto -fstrict-aliasing -Wstrict-aliasing -std=c11 -I$(INCLUDE)
