...
sn3d_files = sn3d.c atomic.c boundary.c emissivities.c gamma.c grey_emissivities.c grid_init.c input.c kpkt.c ltepop.c macroatom.c nltepop.c nonthermal.c packet_init.c photo_electric.c polarization.c radfield.c ratecoeff.c rpkt.c thermalbalance.c update_grid.c update_packets.c vectors.c vpkt.c md5.c

sn3d_objects = sn3d.o atomic.o boundary.o emissivities.o gamma.o grey_emissivities.o grid_init.o input.o kpkt.o ltepop.o macroatom.o nltepop.o nonthermal.o packet_init.o photo_electric.o polarization.o radfield.o ratecoeff.o rpkt.o thermalbalance.o update_grid.o update_packets.o vectors.o vpkt.o md5.o
