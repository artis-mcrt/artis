...
#include <nv/target>
#define MY_IF_DEVICE(...) NV_IF_TARGET(NV_IS_DEVICE, (__VA_ARGS__))  // cppcheck-suppress unknownMacro
#define MY_IF_HOST(...) NV_IF_TARGET(NV_IS_HOST, (__VA_ARGS__))  // cppcheck-suppress unknownMacro
