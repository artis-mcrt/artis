...
enum class ExpansionOpacityMethod { EXPANSION, LINEBINNEDCAPPED, LINEBINNED };
...
static_assert(lowest_set_bit(UINT64_C(1) << 1U) == 1);
static_assert(lowest_set_bit(UINT64_C(1) << 2U) == 2);
static_assert(lowest_set_bit(UINT64_C(1) << 4U) == 4);
static_assert(lowest_set_bit(UINT64_C(1) << 8U) == 8);
static_assert(lowest_set_bit(UINT64_C(1) << 16U) == 16);
static_assert(lowest_set_bit(UINT64_C(1) << 31U) == 31);
static_assert(lowest_set_bit(UINT64_C(1) << 32U) == 32);
static_assert(lowest_set_bit(UINT64_C(1) << 33U) == 33);
static_assert(lowest_set_bit(UINT64_C(1) << 62U) == 62);
static_assert(lowest_set_bit(UINT64_C(1) << 63U) == 63);
static_assert(lowest_set_bit(UINT64_C(3) << 40U) == 40);
static_assert(lowest_set_bit(~UINT64_C(0) << 17U) == 17);
