...
#pragma omp parallel
  ...
  printout(
      "sn3d finished at %ld (ts %d to %d, job wallclock hours %.3f * %d processes * %d threads = %.3f core hours)\n",
      real_time_end, globals::timestep_initial, globals::timestep, (real_time_end - real_time_start) / 3600.,
