...
void zero_estimators() {
  ...
  globals::estimator_gamma_kappa_pp_decayspec = 0.;
  globals::estimator_gamma_kappa_pe_decayspec = 0.;
  globals::estimator_gamma_kappa_c_decayspec = 0.;
  globals::estimator_gamma_kappa_absorbedspec = 0.;
  globals::estimator_gamma_kappa_pp_absorbedspec = 0.;
  globals::estimator_gamma_kappa_pe_absorbedspec = 0.;
  globals::estimator_gamma_kappa_c_absorbedspec = 0.;
...
void normalise_deposition_estimators(int nts) {
  ...
  if (PRINTOUT_EFFECTIVE_GAMMA_OPACITY) {
    ...
    globals::estimator_gamma_kappa_pp_decayspec /= globals::timesteps[nts].gamma_emission;
    globals::estimator_gamma_kappa_pe_decayspec /= globals::timesteps[nts].gamma_emission;
    globals::estimator_gamma_kappa_c_decayspec /= globals::timesteps[nts].gamma_emission;
    ...
    globals::estimator_gamma_kappa_pp_absorbedspec /= globals::timesteps[nts].gamma_dep_discrete;
    globals::estimator_gamma_kappa_pe_absorbedspec /= globals::timesteps[nts].gamma_dep_discrete;
    globals::estimator_gamma_kappa_c_absorbedspec /= globals::timesteps[nts].gamma_dep_discrete;
    ...
    printout(
        "timestep %d %.2f days ||| kappa_eff: decay_tot %.3f decay_pp %.3f decay_pe %.3f "
        "decay_c %.3f ||| deposit_tot %.3f deposit_pp %.3f deposit_pe %.3f deposit_c %.3f ||| "
        "mean gamma E[MeV]: decay %.2f deposit %.2f\n",
        nts, globals::timesteps[nts].mid / DAY, globals::estimator_gamma_kappa_decayspec,
        globals::estimator_gamma_kappa_pp_decayspec, globals::estimator_gamma_kappa_pe_decayspec,
        globals::estimator_gamma_kappa_c_decayspec, globals::estimator_gamma_kappa_absorbedspec,
        globals::estimator_gamma_kappa_pp_absorbedspec, globals::estimator_gamma_kappa_pe_absorbedspec,
        globals::estimator_gamma_kappa_c_absorbedspec, mean_en_decay_mev, mean_en_absorb_mev);
  }
