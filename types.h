...
typedef struct levellist_entry {
  ...
  // double internal_down_same;                 /// Rate for internal downward transitions within the same ionisation
  // stage. double internal_up_same;                   /// Rate for internal upward transitions within the same
  // ionisation stage.
