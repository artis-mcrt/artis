...
> ARTIS is a 3D radiative transfer code for Type Ia supernovae that uses the Monte Carlo method with indivisible energy packets. The source code is public for scientific reference only, and no support is provided to users outside of the collaboration.
