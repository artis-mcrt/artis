...
> ARTIS is a 3D radiative transfer code. This source code is made public for scientific reference only, and no support is provided for its application by users outside of the collaboration.
