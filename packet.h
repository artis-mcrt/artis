...
void read_temp_packetsfile(int timestep, int my_rank, std::vector<Packet>& pkt);
void write_temp_packetsfile(int timestep, int my_rank, std::span<const Packet> pkt);
