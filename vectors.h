...
__host__ __device__ void move_pkt(struct packet *pkt_ptr, double distance, const double time);
...
__host__ __device__
inline double doppler_packet_nucmf_on_nurf(const struct packet *const pkt_ptr)
{
