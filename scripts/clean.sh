...
paths="gridsave*.tmp packets*.tmp vpackets*.tmp *.out *.out.* out.txt output_*-*.txt* exspec*.txt* machine.file.* core.* *.slurm packets vspecpol vpackets speclc_angle_res bflist.dat line_list.txt logfiles.tar*"
