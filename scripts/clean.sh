...
paths="gridsave*.tmp packets*.tmp *.out *.out.* out.txt output_*-*.txt* exspec*.txt* machine.file.* core.* *.slurm packets vspecpol speclc_angle_res bflist.dat logfiles.tar*"
