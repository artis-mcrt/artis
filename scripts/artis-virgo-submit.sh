...
sbatch -J $(basename $(exec pwd)) --ntasks=1920 --mem-per-cpu=1.9GB --partition=long --time=48:00:00 --constraint=amd,epyc,7713 --mail-type=ALL --mail-user=${USER}@gsi.de --no-requeue -- artis/scripts/artis-virgo-slurmjob.sh
