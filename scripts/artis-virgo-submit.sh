...
# sbatch -J $(basename $(pwd)) --ntasks=960 --ntasks-per-node=192 --mem-per-cpu=2000MB --exclusive --partition=long --time=48:00:00 --constraint=amd,epyc,9654 --mail-type=ALL --mail-user=${EMAIL} --no-requeue -- artis/scripts/artis-virgo-slurmjob.sh
