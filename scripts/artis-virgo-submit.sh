...
sbatch -J $(basename $(exec pwd)) --ntasks=960 --ntasks-per-node=192 --mem-per-cpu=2000MB --partition=long --time=24:00:00 --constraint=amd,epyc,9654 --mail-type=ALL --mail-user=${USER}@gsi.de --no-requeue -- artis/scripts/artis-virgo-slurmjob.sh
