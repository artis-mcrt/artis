...
sed -i'' -e 's/constexpr auto PARTICLE_THERMALISATION_SCHEME.*/constexpr ThermalisationScheme PARTICLE_THERMALISATION_SCHEME = ThermalisationScheme::BARNES;/g' artisoptions.h

sed -i'' -e 's/constexpr auto GAMMA_THERMALISATION_SCHEME.*/constexpr ThermalisationScheme GAMMA_THERMALISATION_SCHEME = ThermalisationScheme::BARNES;/g' artisoptions.h
