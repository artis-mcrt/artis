...
if [ ! -f nebularonezone_reference_20210324.tar.xz ]; then curl -O https://theory.gsi.de/~lshingle/artis_http_public/artis/nebularonezone_reference_20210324.tar.xz; fi
