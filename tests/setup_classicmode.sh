...
cp ../artisoptions_classic.h nebularonezone_testrun/artisoptions.h
sed 's/#define MPKTS.*/#define MPKTS 10000/g' nebularonezone_testrun/artisoptions.h > nebularonezone_testrun/artisoptions.h
