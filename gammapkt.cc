...
void pellet_gamma_decay(Packet &pkt_ptr) {
...
static auto get_chi_compton_rf(const Packet &pkt_ptr) -> double {
...
static void compton_scatter(Packet &pkt_ptr)
...
static auto get_chi_photo_electric_rf(const Packet &pkt_ptr) -> double {
...
static auto sigma_pair_prod_rf(const Packet &pkt_ptr) -> double {
...
static void update_gamma_dep(const Packet &pkt_ptr, const double dist, const int mgi, const int nonemptymgi) {
...
void do_gamma(Packet &pkt_ptr, double t2)
