...
std::string inputlinecomments[inputlinecommentcount] = {
    ...
    "REMOVED: change speed of light by some factor (change constants::CLIGHT_PROP instead)",
...
#pragma omp parallel
  ...
  assert_always(fabs(dum2 - 1.0) < 1e-3);  // functionality removed. use constant instead
