...
[[nodiscard]] auto get_rho(std::ptrdiff_t nonemptymgi) -> float;
...
[[nodiscard]] auto get_elem_numberdens(std::ptrdiff_t nonemptymgi, int element) -> double;
...
[[nodiscard]] auto get_stable_initabund(std::ptrdiff_t nonemptymgi, int element) -> float;
[[nodiscard]] auto get_element_meanweight(std::ptrdiff_t nonemptymgi, int element) -> float;
[[nodiscard]] auto get_elem_abundance(std::ptrdiff_t nonemptymgi, int element) -> float;
...
[[nodiscard]] auto get_mgi_of_nonemptymgi(std::ptrdiff_t nonemptymgi) -> int;
