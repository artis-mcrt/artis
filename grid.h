...
__host__ __device__ double get_modelcell_assocvolume_tmin(int modelgridindex);
__host__ __device__ double get_gridcell_volume_tmin(int cellindex);
...
__host__ __device__ float get_rho_tmin(int modelgridindex);
